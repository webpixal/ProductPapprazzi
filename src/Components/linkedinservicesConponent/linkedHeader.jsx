...
const LinkedHeader = () => {
  return (
    <section
      className="h-[324px] xl:h-[648px] w-full bg-cover bg-center flex flex-col justify-center bg-color-blend-mode_linked"
      style={{
        backgroundImage: `url("linked_hero.png")`,
      }}
    >
