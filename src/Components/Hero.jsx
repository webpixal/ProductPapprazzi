  ...
  return (
    <div className="relative flex justify-center items-center">
          ...
          <div className=' 2xl:container md:mx-auto z-50'>
            ...
            <h2 className='text-5xl font-bold mt-[7px]'>Your Audience at First Glance</h2>
            <p className='text-xl font-light mt-[14px]'>Exceptional product photography shapes consumers' crucial initial<br/>
          ...
          <div className="video-docker bg-no-repeat h-[86.6vh] bg-center bg-cover  bg-blend-overlay">
              <video autoPlay loop muted className=" absolute inset-0 object-cover mt-[-131px] h-[100vh] xl:h-[100vh] w-full z-[-1]">
                <source
                  src="Videos/bg1.mp4"
                  type="video/mp4"
                />
