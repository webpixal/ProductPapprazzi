...
const Hero = () => {
  return (
    ...
    <section
      className="h-[424px] xl:h-[648px] w-full bg-cover bg-center flex flex-col justify-center overflow-hidden"
      // style={{
    ...
    >
      ...
      <div className="absolute mx-auto right-16 z-40">
        <span>
          <Line className="mb-[49px] ml-3 max-[1280px]:h-14 h-[85px] min-[1800px]:h-[100%]" />
        </span>
        <span>
          <Facebook className="mb-[49px] hover:bgone" />
          <Linkdin className="mb-[49px] " />
