...
const InfoGraphics = () => {
  return (
    <main className="min-h-[1768px] bg_black bg-black mx-auto mt-28">
      <section className="flex  justify-between flex-col xl:flex-row items-center mx-4 pt-4">
        <div className="md:w-[767px]">
          <h1 className="text-[30px] leading-[40px]  xl:text-[48px] xl:leading-[60px] font-extrabold italic font-sans w-full text-cap capitalize text-white">
          ...
          <p className="text-[20px] font-semibold leading-7 mt-8 text-white">
            Infographics are a powerful visual tool that can help convey complex
            information in an easily digestible format. By transforming your
            professional product photography into infographic images, you can
            enjoy numerous benefits that will elevate your brand's online
            presence and drive sales. Here are the key advantages of using
            infographics <br />
        ...
        <Image
          src={Img_sho}
          className=" w-[586px] h-[586px] md:w-[486px] mt-8 lg:mt-0 md:h-[486px]  xl:w-[586px] xl:h-[586px] rounded-xl"
        />
      </section>
      <section className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 md:justify-items-center  gap-4  mt-12">
        ...
        <div className="mt-20 ml-8 xl:ml-0">
          <p className="leading-6 font-normal text-white tracking-tight mt-2">
            ...
            offers numerous benefits, including simplifying complex information,
            boosting engagement, increasing shareability, enhancing brand
            recognition, supporting SEO, appealing to different learning styles,
            encouraging virality, and facilitating product comparison.
          </p>
          <p className="leading-6 font-normal text-white tracking-tight mt-2">
      ...
      <section className="flex justify-between flex-col lg:flex-row mt-28 mx-4">
        ...
        <div className="relative md:ml-[500px] lg:ml-0 sm:-top-10 lg:left-0">
          <Pattern_colarings />
        </div>
      </section>
    </main>
