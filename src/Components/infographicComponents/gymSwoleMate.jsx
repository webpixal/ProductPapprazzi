...
const GymSwoleMate = () => {
  return (
    <main className="container mx-auto mt-28">
      <div className="flex justify-between flex-col lg:gap-4 lg:flex-row items-center">
        <div className="lg:w-[50%]">
          ...
          <p className="text-2xl text-center lg:mt-8 lg:text-left lg:text-[32px] font-semibold italic tracking-tight">
            ...
            <span className="clip">Product Photography</span> <br />
            and <span className="clip">Infographics</span> for <span className="clip">Maximum Impact</span>
          </p>
